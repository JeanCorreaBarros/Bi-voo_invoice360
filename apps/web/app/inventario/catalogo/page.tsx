...
function ProductCreateModal({ onProductCreated }: { onProductCreated: () => void }) {
  ...
  const [form, setForm] = useState({
    name: "", sku: "", price: "", stock: "", cost: "", category: "", brand: "", unit: "UND", barcode: "", minStock: "", maxStock: "",
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onProductCreated()
      setForm({ name: "", sku: "", price: "", stock: "", cost: "", category: "", brand: "", unit: "UND", barcode: "", minStock: "", maxStock: "" })
      setOpen(false)
    } catch (err: any) {
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
          <div className="flex-1 overflow-y-auto px-6 py-8 scrollbar-hide">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest ml-1">Costo Unitario</label>
                <input
                  name="cost"
                  type="number"
                  min="0"
              ...
              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest ml-1">Unidad de Medida</label>
                <input name="unit" value={form.unit} onChange={handleChange} className={fieldClass} placeholder="UND, KG, CAJA..." />
              </div>

              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest ml-1">Categoría</label>
                <input name="category" value={form.category} onChange={handleChange} className={fieldClass} placeholder="Ej: Empaques" />
              </div>

              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest ml-1">Marca</label>
                <input name="brand" value={form.brand} onChange={handleChange} className={fieldClass} placeholder="Opcional" />
              </div>

              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest ml-1">Código de Barras</label>
                <input name="barcode" value={form.barcode} onChange={handleChange} className={fieldClass} placeholder="Opcional" />
              </div>

              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest ml-1">Stock Mínimo</label>
                <input name="minStock" type="number" min="0" value={form.minStock} onChange={handleChange} className={fieldClass} placeholder="0" />
              </div>

              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest ml-1">Stock Máximo</label>
                <input name="maxStock" type="number" min="0" value={form.maxStock} onChange={handleChange} className={fieldClass} placeholder="Opcional" />
              </div>
            </div>
          </div>
...
function ProductEditModal({ product, onClose, onProductUpdated }: {
  ...
  const [form, setForm] = useState({
    name: "", sku: "", price: "", stock: "", cost: "", category: "", brand: "", unit: "", barcode: "", minStock: "", maxStock: "",
  })
  const [loading, setLoading] = useState(false)
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
          <div className="flex-1 overflow-y-auto px-6 py-8 scrollbar-hide">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest ml-1">Costo Unitario</label>
                <input name="cost" type="number" min="0" step="0.01" value={form.cost} onChange={handleChange} className={fieldClass} />
              </div>
              ...
              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest ml-1">Stock Mínimo</label>
                <input name="minStock" type="number" min="0" value={form.minStock} onChange={handleChange} className={fieldClass} />
              </div>

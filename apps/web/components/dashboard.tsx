...
export function Dashboard() {
  ...
  // Los SUPER_ADMIN no pertenecen a ninguna empresa: este dashboard de
  // facturación no es para ellos (todo lo que pide requiere tenant y
  // les daría 403). Se van directo al panel de empresas.
  useEffect(() => {
  ...
  // SUPER_ADMIN: loader mientras se completa la redirección de arriba
  if (!user.companyId) {
    return <PlcLoader />
  }

          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-4 border-b border-white/5">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-[14px] bg-[#1a1f2c] flex items-center justify-center border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
        ...
        <div className="flex items-center justify-between px-4 lg:px-6 h-14">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-9 h-9 rounded-lg bg-[hsl(209,79%,35%,0.1)] hidden sm:flex items-center justify-center p-1 border border-border">
          ...
          <div className="hidden lg:flex items-center gap-2">
            <DropdownMenu>
              <DropdownMenuTrigger className="focus:outline-none">
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[hsl(209,79%,35%)] hover:bg-[hsl(209,79%,30%)] transition-colors cursor-pointer">
